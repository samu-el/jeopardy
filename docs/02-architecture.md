...
- AI target: OpenAI-compatible service boundary for judging, bot reasoning, and hosted voices.
...
AI judge, AI bots, voice selection, and readout generation. All calls must be optional, timeout-aware, and observable. AI decisions should be overridable by a host.
